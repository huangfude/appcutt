...
public class PorcelainActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_porcelain);
    ...
    private void initTabLayout() {
        PorcelainGridPagerAdappter adapter = new PorcelainGridPagerAdappter(getSupportFragmentManager(), this);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId) {
                    ...
                    case R.id.nav_ceramic:
                        ...
                        return true;
                    case R.id.nav_full:
                        AppUtils.showToast("full", PorcelainActivity.this);
                        return true;
