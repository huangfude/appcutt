...
public class VitrifiedActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId) {
                    ...
                    case R.id.nav_ceramic:
                        intent = new Intent(VitrifiedActivity.this,CeramicActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_full:
                        intent = new Intent(VitrifiedActivity.this,FullActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_porcelain:
                        intent = new Intent(VitrifiedActivity.this,PorcelainActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_rustic:
                        intent = new Intent(VitrifiedActivity.this,RusticActivity.class);
                        startActivity(intent);
                        return true;
