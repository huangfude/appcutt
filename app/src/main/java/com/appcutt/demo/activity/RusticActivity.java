...
public class RusticActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fp.replace(R.id.content_frame, mFragment, "rustic_tag");
        fp.commit();
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId) {
                    case R.id.nav_vitrified:
                        intent = new Intent(RusticActivity.this,VitrifiedActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_ceramic:
                        intent = new Intent(RusticActivity.this,CeramicActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_full:
                        intent = new Intent(RusticActivity.this,FullActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_porcelain:
                        intent = new Intent(RusticActivity.this,PorcelainActivity.class);
                        startActivity(intent);
                        return true;
