...
public class RusticActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_rustic);
    ...
    private void initTabLayout() {
        RusticGridPagerAdappter adapter = new RusticGridPagerAdappter(getSupportFragmentManager(), this);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId) {
                    ...
                    case R.id.nav_ceramic:
                        ...
                        return true;
                    case R.id.nav_full:
                        AppUtils.showToast("full", RusticActivity.this);
                        return true;
                    case R.id.nav_porcelain:
                        AppUtils.showToast("porcelain", RusticActivity.this);
                        return true;
