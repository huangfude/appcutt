            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId) {
                    case R.id.nav_vitrified:
                        intent = new Intent(CeramicActivity.this,VitrifiedActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_ceramic:
                        return true;
                    case R.id.nav_full:
                        intent = new Intent(CeramicActivity.this,FullActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_porcelain:
                        intent = new Intent(CeramicActivity.this,PorcelainActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_rustic:
                        intent = new Intent(CeramicActivity.this,RusticActivity.class);
                        startActivity(intent);
                        return true;
