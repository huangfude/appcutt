...
public class CeramicActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_ceramic);
    ...
    private void initTabLayout() {
        CeramicGridPagerAdappter adapter = new CeramicGridPagerAdappter(getSupportFragmentManager(), this);
    ...
    private void initNavigationView() {
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId) {
                    case R.id.nav_home:
                        Intent intent = new Intent(CeramicActivity.this,HomeActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.nav_vitrified:
                        AppUtils.showToast("vitrified", CeramicActivity.this);
                        return true;
                    ...
                    case R.id.nav_contact:
                        AppUtils.showToast("contact", CeramicActivity.this);
                        return true;
                }
