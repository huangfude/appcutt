...
public class VitrifiedFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    public static VitrifiedFragment newInstance(String param1, String param2) {
        VitrifiedFragment fragment = new VitrifiedFragment();
