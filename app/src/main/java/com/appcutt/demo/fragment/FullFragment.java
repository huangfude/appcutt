...
public class FullFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    private void initTabLayout() {
        FullGridPagerAdappter adapter = new FullGridPagerAdappter(getActivity().getSupportFragmentManager(), getContext());
